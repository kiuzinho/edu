                ...
                <div class="col-md-6">
                  <form id="form-geral1">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="nacionalidade" type="text" value="Brasileiro" id="demo-text-input" required>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="usuario" id="inlineFormInputGroupUsername" placeholder="Nome de usuário" required>
                    </div>
                  </div>
                  <div class="form-group col-md-6">
